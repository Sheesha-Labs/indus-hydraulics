> **Historical record — merged 2026-08-14, applied 2026-05-11.**
>
> This describes the BOP catalogue as first imported. **One third of it was
> deliberately undone the next day:** `2026-05-12-bop-services-migration`
> converted the 13 BOP service products into ServiceCase rows, deleted the
> `bop-services` category, removed the Services sub-section from the megamenu,
> and added 301 redirects from `/p/bop-*` to `/services/*`.
>
> So the "13 services" described below no longer exist as products. Everything
> else — 2 brands, 1 top-level + 9 sub-categories, 3 spec templates, 22
> equipment and 18 spares SKUs — is live and correct.
>
> None of the three import files should be re-run. Each carries a banner
> explaining why.
