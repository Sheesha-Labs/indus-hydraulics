/**
 * Wave 1 of the hose content programme — six reference articles.
 *
 ...
 *
 * Run with:
 *   pnpm --filter @indus/db exec tsx src/imports/2026-08-24-blog-wave-1/run.ts --dry-run
 *   pnpm --filter @indus/db exec tsx src/imports/2026-08-24-blog-wave-1/run.ts
 */
...
import ARTICLE_01 from './articles/sae-100r-hose-types'
import ARTICLE_02 from './articles/en-853-856-857-vs-sae-100r'
import ARTICLE_03 from './articles/hydraulic-hose-dash-sizes'
import ARTICLE_04 from './articles/how-to-read-a-hose-layline'
import ARTICLE_05 from './articles/how-to-measure-a-hydraulic-hose'
import ARTICLE_06 from './articles/hydraulic-thread-size-and-pitch-reference'
