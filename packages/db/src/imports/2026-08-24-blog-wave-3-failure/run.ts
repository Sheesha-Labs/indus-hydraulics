/**
 * Wave 3, failure-diagnosis cluster — ten articles.
 *
 ...
 *
 * Run with:
 *   pnpm --filter @indus/db exec tsx src/imports/2026-08-24-blog-wave-3-failure/run.ts --dry-run
 *   pnpm --filter @indus/db exec tsx src/imports/2026-08-24-blog-wave-3-failure/run.ts
 */
...
import ARTICLE_01 from './articles/hose-burst-at-the-fitting'
import ARTICLE_02 from './articles/hydraulic-hose-cover-blistering'
import ARTICLE_03 from './articles/hydraulic-hose-wire-corrosion'
import ARTICLE_04 from './articles/hydraulic-hose-abrasion-failure'
import ARTICLE_05 from './articles/hydraulic-hose-installed-with-a-twist'
import ARTICLE_06 from './articles/hydraulic-hose-kinked'
import ARTICLE_07 from './articles/hydraulic-hose-tube-swelling'
import ARTICLE_08 from './articles/hydraulic-hose-cover-cracking'
import ARTICLE_09 from './articles/hydraulic-hose-crimp-faults'
import ARTICLE_10 from './articles/hose-failure-post-mortem'
