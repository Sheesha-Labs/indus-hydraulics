  ...
  'inline-flex h-[22px] shrink-0 items-center gap-[5px] whitespace-nowrap px-2 text-[11px] font-medium tracking-normal',
  {
    variants: {
      kind: {
        ...
        steel: 'bg-ih-steel-soft text-[oklch(0.42_0.07_240)]',
        success: 'bg-ih-success-soft text-[oklch(0.38_0.09_150)]',
        warn: 'bg-ih-warning-soft text-[oklch(0.46_0.1_62)]',
        danger: 'bg-ih-danger-soft text-[oklch(0.46_0.13_28)]',
      },
      square: {
