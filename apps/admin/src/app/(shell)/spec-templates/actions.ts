...
export async function updateSpecTemplate(formData: FormData): Promise<Result<void>> {
  try {
    ...
    revalidatePath(`//spec-templates`)
    revalidatePath(`//spec-templates/${parsed.id}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
...
export async function addTemplateField(formData: FormData): Promise<Result<void>> {
  try {
    ...
    revalidatePath(`//spec-templates/${parsed.templateId}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
...
export async function deleteTemplateField(
  ...
  try {
    ...
    revalidatePath(`/spec-templates/${templateId}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
