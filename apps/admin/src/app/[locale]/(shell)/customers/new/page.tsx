...
async function createAccount(formData: FormData) {
  ...
  redirect(`/${locale}/customers/${account.id}`)
}
    ...
    <div className="max-w-[720px]">
      ...
      <form action={createAccount} className="space-y-5">
        ...
        <div className="pt-2 flex gap-3">
          ...
          <Link href={`/${locale}/customers`} className="h-10 px-4 flex items-center border border-[var(--color-border)] text-[13px] text-[var(--color-body)] hover:bg-[var(--color-deep)] transition-colors">
            Cancel
          </Link>
        </div>
      </form>
