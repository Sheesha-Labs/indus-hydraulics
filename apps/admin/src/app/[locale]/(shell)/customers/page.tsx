  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <form method="GET" action={`/${locale}/customers`} className="flex border border-[var(--color-border)] bg-[var(--color-elevated)] h-9">
          <input
            name="q"
            defaultValue={query}
