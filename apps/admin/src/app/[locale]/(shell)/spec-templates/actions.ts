...
export async function createSpecTemplate(formData: FormData): Promise<Result<{ id: string }>> {
  try {
    ...
    revalidatePath(`/${parsed.locale}/spec-templates`)
    return ok({ id: tpl.id })
  } catch (err) {
...
export async function updateSpecTemplate(formData: FormData): Promise<Result<void>> {
  try {
    ...
    revalidatePath(`/${parsed.locale}/spec-templates`)
    revalidatePath(`/${parsed.locale}/spec-templates/${parsed.id}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
...
export async function deleteSpecTemplate(id: string, locale: string): Promise<Result<void>> {
  try {
    ...
    revalidatePath(`/${locale}/spec-templates`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
...
export async function addTemplateField(formData: FormData): Promise<Result<void>> {
  try {
    ...
    revalidatePath(`/${parsed.locale}/spec-templates/${parsed.templateId}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
...
export async function deleteTemplateField(
  ...
  try {
    ...
    revalidatePath(`/${locale}/spec-templates/${templateId}`)
    return ok(undefined)
  } catch (err) {
    return failFromError(err)
  }
