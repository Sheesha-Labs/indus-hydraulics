    ...
    <div>
      ...
      <section className="max-w-[1360px] mx-auto px-8 py-16 grid gap-8 items-center" style={{ gridTemplateColumns: '1fr auto' }}>
        ...
        <div className="flex gap-3 shrink-0">
          <Link href={`/${locale}/quote`} className="h-11 px-6 flex items-center bg-[var(--color-accent)] text-white text-[14px] font-medium hover:opacity-90 transition-opacity whitespace-nowrap">
            Submit an RFQ →
          </Link>
          <Link href={`/${locale}/contact`} className="h-11 px-5 flex items-center border border-[var(--color-border)] text-[14px] text-[var(--color-body)] hover:bg-[var(--color-deep)] transition-colors whitespace-nowrap">
            Contact us
          </Link>
        </div>
      </section>
