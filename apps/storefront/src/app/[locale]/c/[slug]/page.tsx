  ...
  return (
    <div className="max-w-[1360px] mx-auto px-8">
      ...
      <nav className="py-4 border-b border-[var(--color-border-2)] font-mono text-[12px] text-[var(--color-muted)] flex gap-2 items-center">
        ...
        <Link href={`/${locale}/c`} className="hover:text-[var(--color-primary)]">Categories</Link>
        <span className="opacity-40">/</span>
        ...
        <section>
          ...
          <div className="flex justify-between items-center pb-4 border-b border-[var(--color-border-2)] mb-4">
            ...
            <div className="flex items-center gap-2">
              <span className="font-mono text-[11px] text-[var(--color-muted)]">{t('sortBy')}:</span>
          ...
          {products.length === 0 ? (
            <div className="py-16 text-center border border-dashed border-[var(--color-border)]">
              <p className="text-[var(--color-muted)] text-sm">{t('noResults')}</p>
              <p className="text-[var(--color-muted)] text-xs mt-1">{t('noResultsDescription')}</p>
            </div>
          ) : (
