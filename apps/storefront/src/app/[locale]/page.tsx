      ...
      <section className="bg-[var(--color-elevated)] border-b border-[var(--color-border)] overflow-hidden">
        <div className="max-w-[1360px] mx-auto px-8 py-16 grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-16 items-center">
          ...
          <div>
            ...
            {/* Hero search */}
            <form action={`/${locale}/search`} method="GET" className="mt-8 flex bg-[var(--color-surface)] border border-[var(--color-border)] max-w-[540px] gap-1.5 p-1.5">
              <select
                name="category"
      ...
      <section className="py-16">
        <div className="max-w-[1360px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {featuredCat && (
              <Link
                href={`/${locale}/c/${featuredCat.slug}`}
