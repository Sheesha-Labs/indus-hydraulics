    ...
    <div className="max-w-[1360px] mx-auto px-8 py-8 pb-16">
      ...
      {query.length < 2 ? (
        <div className="py-20 text-center">
          <p className="text-[var(--color-muted)] text-sm">Try different keywords or browse our categories.</p>
          <div className="mt-6">
          ...
          <div>
            {products.length === 0 ? (
              <div className="py-16 border border-dashed border-[var(--color-border)] text-center">
                ...
                <p className="text-[var(--color-muted)] text-sm mt-1">Try different keywords or browse our categories.</p>
              </div>
            ) : (
              <>
                {/* Sort row */}
