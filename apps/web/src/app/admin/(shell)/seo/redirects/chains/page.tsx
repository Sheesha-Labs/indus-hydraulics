...
export default async function RedirectChainsPage() {
  ...
  return (
    <div className="max-w-[960px]">
      <div className="mb-6 max-w-[720px] text-[13px] text-[var(--color-muted)]">
          ...
          <table className="w-full text-[13px]">
            ...
            <tbody>
              {chains.map((c) => (
                ...
                >
                  <td className="px-3 py-3 font-mono text-[12px] text-[var(--color-body)]">
                    {c.fromPath}
                    {c.isCycle && (
                  ...
                  <td className="px-3 py-3 font-mono text-[11px] text-[var(--color-muted)]">
                    {c.hops.map((h, i) => (
                      <span key={i}>
                        ...
                        <span
                          className={
                            i === c.hops.length - 1 && !c.isCycle ? 'text-[var(--color-body)]' : ''
                          }
                        >
                          {h}
                        </span>
