...
export const PRODUCT_IMPORT_COLUMNS: ProductImportColumn[] = [
  ...
  { key: 'currency', description: 'USD | EUR | AED | SAR (default: USD)', example: 'AED' },
  ...
  { key: 'stock_warehouse', description: 'Free-text warehouse label shown next to stock pill', example: 'Dubai' },
