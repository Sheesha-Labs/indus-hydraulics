...
import { STATIC_STOREFRONT_REDIRECTS } from './src/lib/static-redirects'
...
export default withSentryConfig(nextConfig, {
  ...
  sourcemaps: sentryAuthToken ? { deleteSourcemapsAfterUpload: true } : { disable: true },
